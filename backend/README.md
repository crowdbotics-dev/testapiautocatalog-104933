...
## Project Structure
    ...
    ├── testapiautocatalog_104933  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_104933`
...
2. Clone this repo and `cd testapiautocatalog_104933`
